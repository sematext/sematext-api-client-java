...
public class TagApiControllerApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Object getUsingGET1(String appIds, List<String> tag, Long from, Long to, Boolean metrics, Boolean logs, Boolean events, Boolean rum) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> getUsingGET1WithHttpInfo(String appIds, List<String> tag, Long from, Long to, Boolean metrics, Boolean logs, Boolean events, Boolean rum) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getUsingGET1Async(String appIds, List<String> tag, Long from, Long to, Boolean metrics, Boolean logs, Boolean events, Boolean rum, final ApiCallback<Object> callback) throws ApiException {
