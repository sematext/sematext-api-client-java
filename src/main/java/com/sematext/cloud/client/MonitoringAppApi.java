...
public class MonitoringAppApi {
     ...
     */
    public com.squareup.okhttp.Call createSpmApplication1Call(CreateAppInfo applicationDetails,
    ...
    private com.squareup.okhttp.Call createSpmApplication1ValidateBeforeCall(CreateAppInfo applicationDetails,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (applicationDetails == null) {
            throw new ApiException(
                    "Missing the required parameter 'applicationDetails' when calling createSpmApplication1(Async)");
        }

        com.squareup.okhttp.Call call = createSpmApplication1Call(applicationDetails, progressListener,
     ...
     *                      deserialize the response body
     */
    public ApiResponse<GenericApiResponse> createSpmApplication1WithHttpInfo(CreateAppInfo applicationDetails)
            throws ApiException {
     ...
     *                      request body object
     */
    public com.squareup.okhttp.Call createSpmApplication1Async(CreateAppInfo applicationDetails,
        ...
        com.squareup.okhttp.Call call = createSpmApplication1ValidateBeforeCall(applicationDetails, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<GenericApiResponse>() {
        }.getType();
