...
public class AppMetadata {
  ...
  **/
  @Schema(example = "zzzzz", description = "")
  ...
  **/
  @Schema(example = "xxxxx", description = "")
  ...
  **/
  @Schema(example = "FIVE_MINUTES", description = "")
   ...
   * @return awsRegion
  **/
  @Schema(example = "US_EAST_1", description = "")
   ...
   * @return subTypes
  **/
  @Schema(example = "aws_ec2,aws_elb", description = "Comma separated list of AWS types monitored by created app")
