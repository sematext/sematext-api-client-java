...
public class AlertRule {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.accountEmail, alertRule.accountEmail)
        ...
        && Objects.equals(this.appId, alertRule.appId) && Objects.equals(this.appName, alertRule.appName)
        && Objects.equals(this.appState, alertRule.appState) && Objects.equals(this.appToken, alertRule.appToken)
        && Objects.equals(this.appType, alertRule.appType)
        && Objects.equals(this.backToNormalNeeded, alertRule.backToNormalNeeded)
        && Objects.equals(this.chartKey, alertRule.chartKey) && Objects.equals(this.color, alertRule.color)
        ...
        && Objects.equals(this.metadata, alertRule.metadata) && Objects.equals(this.metricKey, alertRule.metricKey)
        ...
        && Objects.equals(this.query, alertRule.query) && Objects.equals(this.reportName, alertRule.reportName)
        && Objects.equals(this.ruleKey, alertRule.ruleKey) && Objects.equals(this.ruleType, alertRule.ruleType)
        && Objects.equals(this.runbook, alertRule.runbook) && Objects.equals(this.savedQueryId, alertRule.savedQueryId)
        && Objects.equals(this.schedule, alertRule.schedule)
        && Objects.equals(this.sematextService, alertRule.sematextService)
        && Objects.equals(this.sendToEmail, alertRule.sendToEmail) && Objects.equals(this.timezone, alertRule.timezone)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountEmail, allowedAppTypes, analyzingTime, appDisplayState, appId, appName, appState,
        appToken, appType, backToNormalNeeded, chartKey, color, creatorEmail, defaultAggType, description,
        disallowedAppTypes, enabled, estimateOperation, estimateValue, filterValues, filterValuesObj,
        ignoreRegularEventsEnabled, integrations, lastDataReceivedDate, lastSent, lastTriggered, metadata, metricKey,
        metricLabel, minDelayBetweenNotificationsInMinutes, name, notificationEmails, notificationIntegrations,
        notificationsEnabled, query, reportName, ruleKey, ruleType, runbook, savedQueryId, schedule, sematextService,
        sendToEmail, timezone, useOnlyAlertRuleIntegrations, userPermissions, valueColumnName, valueName);
  }
  ...
  public String toString() {
    ...
    sb.append("    minDelayBetweenNotificationsInMinutes: ")
        .append(toIndentedString(minDelayBetweenNotificationsInMinutes)).append("\n");
