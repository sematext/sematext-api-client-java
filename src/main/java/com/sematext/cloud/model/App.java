...
public class App {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    App app = (App) o;
    return Objects.equals(this.ajaxThreshold, app.ajaxThreshold) && Objects.equals(this.appType, app.appType)
        && Objects.equals(this.appTypeId, app.appTypeId) && Objects.equals(this.creatorEmail, app.creatorEmail)
        && Objects.equals(this.creditCardExpiry, app.creditCardExpiry)
        && Objects.equals(this.creditCardNumber, app.creditCardNumber)
        && Objects.equals(this.description, app.description) && Objects.equals(this.displayStatus, app.displayStatus)
        && Objects.equals(this.firstDataSavedDate, app.firstDataSavedDate) && Objects.equals(this.id, app.id)
        ...
        && Objects.equals(this.monthlyInvoiceAccount, app.monthlyInvoiceAccount) && Objects.equals(this.name, app.name)
        ...
        && Objects.equals(this.paymentMethodId, app.paymentMethodId) && Objects.equals(this.plan, app.plan)
        && Objects.equals(this.prepaidAccount, app.prepaidAccount) && Objects.equals(this.status, app.status)
        && Objects.equals(this.token, app.token) && Objects.equals(this.trialEndDate, app.trialEndDate)
        && Objects.equals(this.urlGroupLimit, app.urlGroupLimit) && Objects.equals(this.userRoles, app.userRoles);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ajaxThreshold, appType, appTypeId, creatorEmail, creditCardExpiry, creditCardNumber,
        description, displayStatus, firstDataSavedDate, id, integration, lastDataReceivedDate, lastDataSavedDate,
        loggedInUserAppRole, monthlyInvoiceAccount, name, ownerEmail, owningOrganization, pageLoadThreshold,
