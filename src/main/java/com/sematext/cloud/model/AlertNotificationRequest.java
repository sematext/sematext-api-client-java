...
public class AlertNotificationRequest {
  ...
  **/
   ...
   * @return end
  **/
  @Schema(description = "End time of interval. Can be expressed as timestamp in milliseconds or UTC date in yyyy-MM-dd HH:mm:ss format")
  ...
  **/
   ...
   * @return start
  **/
  @Schema(description = "Start time of interval. Can be expressed as timestamp in milliseconds or UTC date in yyyy-MM-dd HH:mm:ss format")
